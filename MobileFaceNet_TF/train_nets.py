...
def get_parser():
    ...
    parser.add_argument('--eval_datasets', default=['lfw', 'cfp_ff', 'cfp_fp', 'agedb_30'], help='evaluation datasets')
    ...
    parser.add_argument('--tfrecords_file_path', default='./datasets/faces_vgg_112x112/tfrecords', type=str,
