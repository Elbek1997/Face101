...
def parse_args():
    ...
    parser.add_argument('--bin_path', default='./datasets/faces_emore/train.rec', type=str,
                        help='path to the binary image file')
    parser.add_argument('--idx_path', default='./datasets/faces_emore/train.idx', type=str,
                        help='path to the image index path')
    parser.add_argument('--tfrecords_file_path', default='./datasets/faces_emore/tfrecords', type=str,
